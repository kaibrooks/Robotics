import darknet as dn    "Darknet library used to read weights"
import logging          "Error logging library"
import cv2              "Open CV libraries - requires numpy"
import os               "Allows you to interface with underlying OS"
import numpy as np      "OpenCV arrays converted to numpy arrays and back"
import sys              "Provides info about interacting with host OS"
import zerorpc          "Messaging for server/client communication"
import msgpack          "Messaging protocol, zerorpc builds on top of it"
